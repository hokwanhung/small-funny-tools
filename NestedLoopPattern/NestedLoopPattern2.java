public class NestedLoopPattern2 {
	 ...
	 * The reason assuring `i = 1` is because we know each line have at most 5 spots. 
	*/
	...
	public static void pattern2() {
		for (int i = 1; i <= 5; i++) { // Define how many "*" and " " in each line.
			...
			for (int k = 2; k <= i; k++) { // Print out " ". 
				// (SOOOO WEIRD) - Not weird, as we are trying to avoid printing " " in the first line only.
				// The initialize of k determines how many lines of printing " " (action) to be skipped.
				System.out.print(" ");
			}
			System.out.println();
		}
